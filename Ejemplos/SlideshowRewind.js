...
(function(win, doc){
    ...
    Content += 'erv-slideshow[data-type="Rewind"][data-orientation="Horizontal"], erv-slideshow[data-type="Rewind"][data-orientation="Vertical"]{ overflow: hidden; display: -ms-flexbox; display: -webkit-flex; display: flex;}';
    ...
    Content += 'erv-slideshow[data-type="Rewind"][data-orientation="Horizontal"] erv-roll, erv-slideshow[data-type="Rewind"][data-orientation="Vertical"] erv-roll{ left: 0; width: 100%; height: 100%; white-space: nowrap; font-size: 0; }';
    ...
    const ervSlideshow = (function(win, doc){
        ...
        const Slideshow = function(tag, options){
            ...
            if( tag.tagName !== "ERV-SLIDESHOW"){ alert("[tag] is not a valid tag!");  throw "[tag] is not a valid tag!"; }
            ...
            if(options){
                if( !options.Transition && !options.Ratio       && !options.Callback &&
                    ...
                    alert("[options] is not a valid object!");  throw "[options] is not a valid object!";
                }
            }
            ...
            this[Index] = 0;
            const self = this;
            this[Callback] = function(index, element, self){  };
            ...
            if(!this[Orientation]){ alert("[orientation] is not defined!"); throw "[orientation] is not defined!"; }

            if(!this[Name]){ alert("[Name] is not defined!"); throw "[Name] is not defined!"; }
                ...
                value: function(){
                    ...
                    if(Indexx === this.Count - 1){
                        ...
                        if(this.Continuity === "Pseudo-continuous" && this.Count > 2){
                            ...
                            const self = this;
                            this.Callback(Indexx, this.Slides[1], self);
                            this[Flag] = true;
